...
internal static class UiStrings
{
    ...
    public const string TitleSwapVehicle = "Wymień pojazd";
    public const string EntityEvent = "zdarzenie";
    public const string HintDeleteVehicle = "Usuń pojazd";
    public const string HintRepair = "Naprawa";
    public const string Company = "Firma";
    public const string Policy = "Polisa";
    public const string PolicyDisplayName = "Nazwa";
    public const string Type = "Typ";
    public const string EventStatusActive = "Aktywne";
    public const string EventStatusCompleted = "Zakończone";
    public const string EventStatusPlanned = "Planowane";
    public const string TabDetails = "Szczegóły";
    public const string TabInsurances = "Ubezpieczenia";
    public const string TabEvents = "Zdarzenia";
