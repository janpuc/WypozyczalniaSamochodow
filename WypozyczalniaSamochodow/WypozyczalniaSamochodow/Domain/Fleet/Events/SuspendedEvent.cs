...
internal sealed class SuspendedEvent : VehicleEvent
{
    public SuspendedEvent(DateOnly from, string? description = null)
        : base(DateRange.OpenEnded(from), description) { }
    public override string Describe() => "Wstrzymany";
